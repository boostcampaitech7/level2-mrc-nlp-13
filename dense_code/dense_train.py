...
from dense_util import InBatchNegativeRandomDataset
...
def main(args):
    ...
    torch.save(p_encoder.state_dict(), './dense_model/' + 'p_encoder.pt')
    torch.save(q_encoder.state_dict(), './dense_model/' + 'q_encoder.pt')
